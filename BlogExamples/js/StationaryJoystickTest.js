...
function animate(){
   ...
   if( joystick.right() ){
	cube.position.x = cube.position.x + 60 * frameTime;
        //debugText1.innerHTML = "right";
        //if( joystick.up()==false && joystick.down()==false ) debugText2.innerHTML = "";
   }
   if( joystick.left() ){
	cube.position.x = cube.position.x - 60 * frameTime;
        //debugText1.innerHTML = "left";
        //if( joystick.up()==false && joystick.down()==false ) debugText2.innerHTML = "";
   }
   if( joystick.up() ){
	cube.position.y = cube.position.y + 60 * frameTime;
        //debugText2.innerHTML = "up";
        //if( joystick.right()==false && joystick.left()==false ) debugText1.innerHTML = "";
   }
   if( joystick.down() ){
	cube.position.y = cube.position.y - 60 * frameTime;
        //debugText2.innerHTML = "down";
        //if( joystick.right()==false && joystick.left()==false ) debugText1.innerHTML = "";
   }
   ...
   //debugText1.innerHTML = "Touch Delta X: " + joystick.deltaX();
   //debugText2.innerHTML = "Touch Delta Y: " + joystick.deltaY();
